...
def calculator():
    ...
    #PRINT ANSWER TO USER
        ...
        print(f"\n{num1} + {num2} is equal to {addition}\n")
    ...
    #PRINT ANSWER TO USER
        ...
        print(f"\n{num1} + {num2} is equal to {subtraction}\n")
    ...
    #PRINT ANSWER TO USER
        ...
        print(f"\n{num1} + {num2} is equal to {multiplication}\n")
    ...
    #PRINT ANSWER TO USER
        ...
        print(f"\n{num1} + {num2} is equal to {division}\n")
    ...
    #PRINT ANSWER TO USER
        ...
        print(f"\n{num1} + {num2} is equal to {Quotient}\n")
    ...
    #PRINT ANSWER TO USER
        ...
        print(f"\n{num1} + {num2} is equal to {Exponent}\n")
        break
...
def print_options():
    ...
    while True:
        ...
        print("\nI appreciate your time and hope to see you in the next one!\n")
        break 
...
if __name__ == '__main__':
    ...
    while True:
        ...
        program_choice = input("Enter the program number (1 - 7): ")
        print("/////////////////////////////////////////////////")
